...
namespace FtpWork
{
    public partial class MainForm : Form
    {
        ...
        private void btnFtpConnect_Click(object sender, EventArgs e)
        {
            try
            {
                ftpHelper = new FtpHelper(tbFtpHost.Text, 21, tbFtpUserName.Text, tbPassword.Text);
        ...
        public void loadRemoteDirList()
        {
            ...
            try
            {
                FtpListItem[] listItems = JsonConvert.DeserializeObject<FtpListItem[]>(ftpHelper.GetFtpListItemsJson(lblRemoteDirPath.Text));
        ...
        private void downloadThreadFunc()
        {
            try
            {
                ...
                foreach (ListViewItem item in selectedItems)
                {
                    ...
                    ftpHelper.Download(remotePath, localPath);
